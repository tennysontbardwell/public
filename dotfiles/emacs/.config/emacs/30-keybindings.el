...
(spacemacs/set-leader-keys "oiw" 'tennyson/firefox-insert-frontmost-link)
(spacemacs/set-leader-keys "oiW" 'tennyson/firefox-insert-frontmost-link-and-close)
(spacemacs/set-leader-keys "oIW" 'tennyson/firefox-ivy-select-and-close-tabs)
